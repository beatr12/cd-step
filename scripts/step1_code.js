export function run(sheet) {

  // 让 KS 代码能访问 Application.ActiveSheet
  Application.ActiveSheet = sheet;

  // ============================================================
  // ★ 你的 KS 原始代码（除了 KSDrive 那段，其余全部原样）
  // ============================================================
  ...
  // ============================================================
  // ★ 替换 KSDrive：直接使用 vioList（由外部加载）
  // ============================================================

  let violations = vioList.slice();  // ← 唯一改动
  ...
  const vioList2 = Array.from(vioSet);
